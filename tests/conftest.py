...
sys.path.insert(0, str(PROJECT_ROOT / "ui" / "theme"))
sys.path.insert(0, str(PROJECT_ROOT / "ui" / "lockscreen"))
sys.path.insert(0, str(PROJECT_ROOT / "ui" / "notifications"))
sys.path.insert(0, str(PROJECT_ROOT / "ui" / "appdrawer"))
